...
const double numberOfGridElements = 100; //you divide the graphicsView in a grid with noOfGridEl^2 squares

//probabilities regarding block creation for track
const double probabilityToGoBlockUpDown = 0.1;
const double probabilityToNoBlock = 0.1;
const int maxHeightChange = 3;
