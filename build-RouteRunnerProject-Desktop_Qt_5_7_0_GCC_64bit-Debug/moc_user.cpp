...
#include "../RouteRunnerProject/user.h"
...
QT_MOC_LITERAL(1, 5, 17), // "increaseHighscore"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 7) // "ammount"

    },
    "User\0increaseHighscore\0\0ammount"
};
...
void User::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->increaseHighscore((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
